      ...
      child: BottomNavigationBar(
        ...
        items: [
          BottomNavigationBarItem(
            icon: SvgPicture.asset(ImageAssets.iconSvgHome1, width: 24.w),
          ...
          BottomNavigationBarItem(
            ...
            activeIcon: SvgPicture.asset(ImageAssets.iconSvgLeadsWhite, width: 24.w),
            label: "Leads",
          ),
          BottomNavigationBarItem(
            icon: SvgPicture.asset(ImageAssets.iconSvgCalendarWhite, width: 24.w),
            activeIcon: SvgPicture.asset(ImageAssets.iconSvgCalendarWhite, width: 24.w),
            label: "Calendar",
          ),
          BottomNavigationBarItem(
            icon: SvgPicture.asset(ImageAssets.iconSvgProfileWhite, width: 24.w),
            activeIcon: SvgPicture.asset(ImageAssets.iconSvgProfileWhite, width: 24.w),
            label: "Profile",
          ),
        ],
      ),
