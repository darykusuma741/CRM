...
class CustomerFormDetailIndividual extends GetView<CustomerFormController> {
  const CustomerFormDetailIndividual({super.key});
      ...
      return Column(
        ...
        children: [
          ...
          CustomTextEditing(
            ...
            onChanged: (v) => controller.nameErr.value = null,
            error: controller.nameErr.value,
          ),
          CustomDropdown<String>(
            label: 'Company Name',
            required: false,
            selectedItem: controller.companyNameSelect.value,
            items: ['ScaleOcean'],
            customContent: (p0) => p0 == null ? 'Select company name' : p0.toString(),
            onChanged: (v) => controller.companyNameSelect.value = v,
          ),
          CustomTextEditing(
            label: 'Email',
            required: false,
