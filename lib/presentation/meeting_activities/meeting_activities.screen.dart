...
import 'controllers/meeting_activities.controller.dart';

class MeetingActivitiesScreen extends GetView<MeetingActivitiesController> {
  const MeetingActivitiesScreen({super.key});
  @override
                ...
                child: Row(
                  ...
                  children: [
                    Container(
                      ...
                      child: Center(
                        child: SvgPicture.asset(ImageAssets.iconSvgMeeting, width: 16.w),
                      ),
                    ),
                    Expanded(
                      child: Column(
                    ...
                    CustomInkWell(
                      onTap: () => Get.toNamed(Routes.CHECK_IN, arguments: item),
                      // onTap: () => controller.onClickDetail(item),
                      height: 30.h,
                      width: 68.w,
                      decoration: BoxDecoration(
