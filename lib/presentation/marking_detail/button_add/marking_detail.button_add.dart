...
class MarkingDetailButtonAdd extends GetView<MarkingDetailController> {
  const MarkingDetailButtonAdd({super.key});

  @override
  Widget build(BuildContext context) {
    return InkWell(
      onTap: controller.onClickAddMarking,
      ...
      child: Ink(
        ...
        child: Row(
          ...
          children: [
            ...
            SizedBox(width: 3.w),
            Text('Add Marking', style: BaseText.blueSteel.copyWith(fontSize: 12.sp)),
          ],
        ),
      ),
    );
